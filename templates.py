...
# A list of filepath to be created:
list_of_files=[
    ...
    f"src/{project_name}/utils/main_utils/common.py",
...
# Looping through the list of files and creating the folder and filnames if they don't exist:
